...
var Orderform = React.createClass({
  ...
  handleSubmit: function (e) {
    ...
    if (!orderdate || !ordertime || !playerid) {
...
var OrderItemform = React.createClass({
  ...
  handleSubmit: function (e) {
    ...
    var productid = pdcnum.value;

    // Check to see if inputs are missing
    if (!itemquantity || !orderid || !productid) {
      console.log("Field Missing");
      return;
    }
        ...
        <table>
          <tbody>
            ...
            <tr>
              <th>Product</th>
              <td>
                <ProductList data={this.state.pdcdata} />
              </td>
            </tr>
            <tr>
