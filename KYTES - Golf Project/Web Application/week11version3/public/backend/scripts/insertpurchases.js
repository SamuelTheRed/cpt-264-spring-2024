...
var Purchaseform = React.createClass({
  ...
  handleSubmit: function (e) {
    ...
    var purchaseinformation = statusnum.value;
    var purchasedate = this.state.purchasedate.trim();
    var purchasetime = this.state.purchasetime.trim();
    var orderid = ordnum.value;

    if (!purchaseinformation || !purchasedate || !purchasetime) {
        ...
        <table>
          <tbody>
            ...
            <tr>
              ...
              <td>
                <DateInput
                  ...
                  onChange={this.setValue.bind(this, "purchasedate")}
            ...
            <tr>
              ...
              <td>
                <TimeInput
                  ...
                  minCharacters={3}
                  validate={this.commonValidate}
                  onChange={this.setValue.bind(this, "purchasetime")}
            ...
            <tr>
              <th>Order</th>
              <td>
                <OrderList data={this.state.orddata} />
              </td>
            </tr>
          </tbody>
        </table>
